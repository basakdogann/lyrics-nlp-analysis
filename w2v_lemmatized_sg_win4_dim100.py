# w2v_lemmatized_sg_win4_dim100.py
...
# 1. Modeli yükle
model = Word2Vec.load("word2vec_lemmatized_skipgram_win4_dim100.model")
...
# 7. Yazdır
print("Word2Vec (lemmatized_skipgram_win4_dim100) için en benzer 5 cümle:\n")
