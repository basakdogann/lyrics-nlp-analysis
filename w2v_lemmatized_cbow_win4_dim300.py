# w2v_lemmatized_cbow_win4_dim300.py
...
# 1. Modeli yükle
model = Word2Vec.load("word2vec_lemmatized_cbow_win4_dim300.model")
...
# 7. Yazdır
print("Word2Vec (lemmatized_cbow_win4_dim300) için en benzer 5 cümle:\n")
