# w2v_lemmatized_cbow_win4_dim100.py

from gensim.models import Word2Vec
from sklearn.metrics.pairwise import cosine_similarity
import numpy as np

# 1. Word2Vec modelini yükle
model = Word2Vec.load("word2vec_lemmatized_cbow_win4_dim100.model")

# 2. Cümleleri dosyadan oku
...
# 7. Sonuçları yazdır
print("Word2Vec (lemmatized_cbow_win4_dim100) için en benzer 5 cümle:\n")
