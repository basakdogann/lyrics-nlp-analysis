# w2v_stemmed_cbow_win2_dim100.py
...
# 2. Veri dosyasını oku (ilk 1000 cümleyle sınırlı)
with open("stemmed_tokenler.txt", "r", encoding="utf-8") as file:
    corpus = [line.strip().split() for line in file if line.strip()][:10000]


# 3. Giriş cümlesi (stemmed versiyon)
input_sentence = "kalp kır sus"
input_tokens = input_sentence.split()

# 4. Token kontrolü: modelde var mı?
...
# 6. Tüm cümlelerle benzerlik hesapla
similarities = []
...
# 8. Sonuçları yazdır
print("\nWord2Vec (stemmed_cbow_win2_dim100) için en benzer 5 cümle:\n")
