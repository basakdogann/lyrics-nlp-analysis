...
# 1. Modeli yükle
model = Word2Vec.load("word2vec_lemmatized_skipgram_win2_dim100.model")
...
# 3. Giriş cümlesini hazırla
input_sentence = "kalbim kırık suskunum"
input_tokens = input_sentence.split()

# 4. Ortalama vektör alma fonksiyonu
...
# 7. Yazdır
print("Word2Vec (lemmatized_skipgram_win2_dim100) için en benzer 5 cümle:\n")
