...
# 1. Modeli yükle
model = Word2Vec.load("word2vec_stemmed_skipgram_win4_dim100.model")

# 2. Tüm veri dosyasını oku
...
# 8. Yazdır
print("\nWord2Vec (stemmed_skipgram_win4_dim100) için en benzer 5 cümle:\n")
