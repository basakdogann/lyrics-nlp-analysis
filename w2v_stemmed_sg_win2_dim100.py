...
# 2. Veri dosyasını oku (gerekirse ilk 50000 satırla test yap)
with open("stemmed_tokenler.txt", "r", encoding="utf-8") as file:
    corpus = [line.strip().split() for line in file if line.strip()][:50000]
...
# 6. Tüm cümlelerle benzerlik hesapla (ilerleme çıktılı)
similarities = []
...
# 8. Yazdır
print("\nWord2Vec (stemmed_skipgram_win2_dim100) için en benzer 5 cümle:\n")
