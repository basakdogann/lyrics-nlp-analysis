# w2v_stemmed_cbow_win2_dim300.py
...
# 1. Modeli yükle
model = Word2Vec.load("word2vec_stemmed_cbow_win2_dim300.model")
...
# 4. Modelde kelimeler var mı kontrol
...
# 6. Tüm cümlelerle benzerlik hesapla (ilerleme göstergeli)
similarities = []
...
# 8. Yazdır
print("\nWord2Vec (stemmed_cbow_win2_dim300) için en benzer 5 cümle:\n")
